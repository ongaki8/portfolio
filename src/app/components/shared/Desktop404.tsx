  ...
  return (
    <div className="h-full bg-gradient-to-br from-gray-900 to-gray-800 p-4 sm:p-8 overflow-auto">
      ...
      <div className="flex items-start justify-center p-4 mt-4">
        <div className="w-full max-w-5xl rounded-md overflow-hidden bg-[#252526] border border-[#37373d] shadow-xl">
          {/* VS Code Title Bar */}
          <div className="bg-[#181818] border-b border-[#37373d] px-3 py-2 flex items-center justify-between">
            <div className="flex-1 flex justify-center items-center">
              <span className="">pageData.tsx - NEW_PAGE</span>
            </div>
          </div>
          ...
          <div className="flex h-[350px]">
            <div className="flex h-[350px]">
              <div className="w-12 bg-[#181818] flex flex-col items-center py-4 border-r border-[#37373d]">
                {/* Active Document Icon with blue indicator */}
                <div className="relative w-full">
                  <div className="absolute left-0 w-1 h-8 bg-[#0078d4]"></div>
                  <button className="p-2 text-white w-full flex justify-center cursor-pointer">
                    <Files className="w-5 h-5" />
                  </button>
                </div>

                {/* Search Icon */}
                <button className="p-2 text-[#858585] mt-4 hover:text-white cursor-pointer">
            ...
            {/* VS Code Sidebar */}
            <div className="w-48 bg-[#181818] border-r border-[#37373d] p-3 text-sm">
              <div className="text-xs text-[#858585] uppercase mb-3">EXPLORER</div>
              <div className="text-[#cccccc] mb-4">
                <div className="flex items-center py-1 px-2 rounded hover:bg-[#2a2d2e] cursor-pointer">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
              {/* Editor Tabs */}
              <div className="bg-[#181818] flex items-center border-b border-[#37373d]">
                <div className="px-4 py-2 text-sm bg-[#1e1e1e] text-[#ffffff] border-t-1 border-[#0078d4] flex items-center cursor-pointer">
                  <FaReact className="w-4 h-4 mr-2 text-[#519aba]" />
                  pageData.tsx
                </div>
              </div>
          ...
          {/* VS Code Panel */}
          <div className="border-t border-[#37373d] h-35 flex flex-col">
            <div className="bg-[#181818] px-3 py-1 flex text-xs">
              <button 
                className={`px-4 py-1 ${activePanel === 'terminal' ? 'text-white border-b border-[#0078d4] cursor-pointer' : 'text-[#858585] cursor-pointer'}`}
                onClick={() => setActivePanel('terminal')}
              >
                TERMINAL
              </button>
              <button 
                className={`px-4 py-1 ${activePanel === 'problems' ? 'text-white border-b border-[#0078d4] cursor-pointer' : 'text-[#858585] cursor-pointer'}`}
                onClick={() => setActivePanel('problems')}
              >
                PROBLEMS
              </button>
            </div>
            <div className="flex-1 bg-[#181818] p-3 text-sm font-mono overflow-auto text-[#d4d4d4]">
                ...
                <div>
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <motion.span
                      ...
                      className="ml-1 inline-block w-2 h-4 bg-[#4ec9b0]"
                    />
                  </div>
                </div>
              )}
              {activePanel === 'problems' && (
                <div>Checked twice. Still looks fine.</div>
              )}
            </div>
          </div>
