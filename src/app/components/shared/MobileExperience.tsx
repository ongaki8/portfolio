...
export default function MobileExperience() {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-gray-900 to-gray-900 p-4 overflow-x-hidden">
          ...
          <div className="relative">
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div 
                  className="bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-700 hover:border-blue-500 transition-all duration-300 cursor-pointer"
                  onClick={() => setExpandedExperience(expandedExperience === index ? null : index)}
                >
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <h3 className="text-base font-medium text-white">{exp.company}</h3>
                      <p className="font-mono text-blue-500 text-sm mb-1">{exp.role}</p>
                      <span className="text-xs font-mono text-gray-400 bg-gray-900 px-2 py-0.5 rounded inline-block mb-2">
                        {exp.period}
                      </span>
                      <p className="text-xs text-gray-300 mb-2">{exp.description}</p>
                      <div className="flex flex-wrap gap-1 mb-2">
                        {exp.tech.map((tech, i) => (
                          <span key={i} className="text-[0.7rem] font-mono bg-gray-900 text-blue-500 px-1.5 py-0.5 rounded">
                            {tech}
                          </span>
                        ))}
                      </div>
                      ...
                      >
                        <div className="pt-2 border-t border-gray-700">
                          <h4 className="text-xs font-semibold text-blue-500 mb-1">KEY_RESPONSIBILITIES</h4>
