      ...
      <div className="bg-gray-100/80 dark:bg-gray-900/80 backdrop-blur-sm border border-gray-400/30 dark:border-gray-800 rounded-3xl overflow-hidden shadow-xl">
        {activeTab === 'social' && (
          <motion.div
            ...
            className="p-4"
          >
            <h2 className="text-lg font-mono font-medium text-blue-600 dark:text-blue-400 mb-4 flex items-center">
              ...
              {socialLinks.map((social, index) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h3 className="text-gray-800 dark:text-white font-medium text-sm">{social.name}</h3>
        ...
        {activeTab === 'form' && (
          <motion.div
            ...
            className="p-4"
          >
            <h2 className="text-lg font-mono font-medium text-purple-700 dark:text-purple-500 mb-4 flex items-center">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex justify-center">
                <motion.button
                  ...
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className={`px-4 py-2 bg-gradient-to-r from-purple-100 dark:from-purple-900/50 to-purple-100 dark:to-purple-900/50 rounded-lg text-purple-800 dark:text-purple-300 font-mono text-xs font-medium border border-purple-800/30 dark:border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/20 transition-all mb-1 ${
