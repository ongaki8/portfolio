...
export default function MobileAboutMe() {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 p-4 overflow-auto">
    <div className="max-w-6xl mx-auto">
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-lg font-medium font-mono text-gray-900 dark:text-white">ABOUT_ME</h2>
        </div>
                ...
                <div key={index} className="flex items-center gap-2">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between mb-1">
                      <span className="text-xs text-gray-700 dark:text-gray-300">{lang.name}</span>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-lg font-medium font-mono text-gray-900 dark:text-white">PROFICIENCY_SCALE</h2>
        </div>
          ...
          {proficiencyScale.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-2 mb-1">
                {item.icon}
                <span className="font-mono text-blue-600 dark:text-blue-500 text-sm">{item.range}</span>
              </div>
              <h3 className="font-mono text-gray-900 dark:text-white text-sm font-medium mb-1">{item.level}</h3>
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          <div className="p-1 bg-purple-100 dark:bg-purple-900/30 rounded-lg">
            <LayoutTemplate className="text-purple-600 dark:text-purple-400" size={20} />
          </div>
          <h2 className="text-lg font-medium font-mono text-gray-900 dark:text-white">CMS_EXPERIENCE</h2>
        </div>
      ...
      <div className="relative mb-8">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-lg font-medium font-mono text-gray-900 dark:text-gray-200 flex items-center gap-2">
            <Cpu className="text-purple-600 dark:text-purple-400" size={16} />
            SKILL_CATEGORIES
          </h2>
          <div className="flex gap-2">
            ...
            >
              <ChevronLeft className="text-gray-900 dark:text-white" size={18} />
            </button>
            <button 
              onClick={nextCategory}
              className="p-1 rounded-full bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors"
            >
              <ChevronRight className="text-gray-900 dark:text-white" size={18} />
            </button>
          </div>
        </div>
        ...
        <div className="relative h-68 overflow-hidden">
          ...
          <motion.div 
            className="absolute left-0 top-1/2 transform -translate-y-1/2 w-[80%] h-48 bg-gray-200/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-lg p-4 border border-gray-200 dark:border-gray-600 z-0"
            style={{ x: '-80%' }}
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              <div className="p-1 bg-gray-300 dark:bg-gray-700 rounded-lg">
          ...
          {/* Next Card Preview */}
          <motion.div 
            className="absolute right-0 top-1/2 transform -translate-y-1/2 w-[80%] h-48 bg-gray-200/30 dark:bg-gray-800/30 backdrop-blur-sm rounded-lg p-4 border border-gray-200 dark:border-gray-600 z-0"
            style={{ x: '80%' }}
            initial={{ opacity: 0.5, scale: 0.8 }}
            animate={{ opacity: 0.5, scale: 0.8 }}
            transition={{ duration: 0.3 }}
              ...
              <div className="space-y-3">
                {skillCategories[currentCategory].skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="group">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-gray-700 dark:text-gray-300 font-mono text-xs">{skill.name}</span>
          ...
          {skillCategories.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-colors ${
                index === currentCategory ? 'bg-blue-500' : 'bg-gray-400 dark:bg-gray-600'
              }`}
            />
          ))}
        </div>
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h2 className="text-lg font-medium font-mono text-gray-900 dark:text-gray-200 mb-4 flex items-center gap-2">
          <Cpu className="text-blue-600 dark:text-blue-500" size={16} />
          TECH_VISUALIZATION
        </h2>
        ...
        <div className="bg-gray-100/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl p-4 border border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-2 gap-3 text-center">
            ...
            >
              ...
              <p className="text-xs font-mono text-blue-600 dark:text-blue-500 mt-1">4 languages</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs font-mono text-green-600 dark:text-green-500 mt-1">5 languages</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs font-mono text-purple-600 dark:text-purple-500 mt-1">4 tools</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-xs font-mono text-yellow-600 dark:text-yellow-500 mt-1">1 spec.</p>
            </motion.div>
          </div>
        </div>
      </motion.div>
