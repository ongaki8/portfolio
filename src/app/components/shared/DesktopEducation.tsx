  ...
  return (
    ...
    >
      ...
      <section className="mb-12">
        <h2 className="text-xl font-mono text-gray-800 dark:text-gray-200 mb-6 flex items-center gap-2">
        ...
        <div className="relative">
          ...
          {educationData.map((item, index) => (
            ...
            >
              <div className="absolute left-5 top-1/3 transform -translate-x-1/2 -translate-y-1/2 w-5 h-5 rounded-full bg-blue-500 border-4 border-blue-100 dark:border-blue-900 z-10 animate-pulse"></div>
              ...
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="font-mono text-blue-600 dark:text-blue-500 mb-1">{item.degree}</p>
                    ...
                    <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {item.skills?.map((skill, skillIndex) => (
                          <span 
                            key={skillIndex}
                            className="px-3 py-1 bg-blue-100 dark:bg-blue-900/50 text-blue-800 dark:text-blue-200 text-xs font-mono px-2 py-1 rounded inline-block"
                          >
                            {skill}
                          </span>
                        ))}
          ...
          >
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-xs font-mono text-gray-400 bg-gray-900 px-2 py-2 rounded inline-block mb-2">
              ...
              <div className="p-5">
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    ...
                    <p className="font-mono text-sm text-purple-500 dark:text-purple-500 bg-gray-900 px-2 py-2 rounded inline-block mb-2">{cert.description}</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <button 
                      onClick={(e) => {
                ...
                {expandedCertificates.includes(index) && (
                  ...
                  >
                    <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                      <h4 className="font-mono text-sm font-semibold text-purple-500 dark:text-purple-500 mb-2">KEY_LEARNINGS</h4>
          ...
          {awards.map((award, index) => (
            ...
            >
              <div className="flex items-start gap-4">
                ...
                {/* <button 
                  onClick={() => openAttachment(award.attachment)}
                  className="text-gray-400 hover:text-yellow-500 transition-colors hover:cursor-pointer"
