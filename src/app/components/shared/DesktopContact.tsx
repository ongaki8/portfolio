...
export default function DesktopContact() {
  ...
  return (
    <div className="h-full bg-gradient-to-br from-gray-900 to-gray-800 p-8 overflow-auto">
        ...
        <div className="flex justify-center mb-8">
          <div className="inline-flex bg-gray-800 rounded-lg p-1 border border-gray-700">
            <button
              ...
              className={`px-4 py-2 rounded-md font-mono text-sm font-medium transition-all ${activeTab === 'social' ? 'bg-blue-900/50 text-blue-400 border border-blue-500/30' : 'text-gray-400 hover:text-white'}`}
            >
              SOCIAL_TERMINAL
            </button>
            <button
              onClick={() => setActiveTab('form')}
              className={`px-4 py-2 rounded-md font-mono text-sm font-medium transition-all ${activeTab === 'form' ? 'bg-purple-900/50 text-purple-400 border border-purple-500/30' : 'text-gray-400 hover:text-white'}`}
            >
              MESSAGE_CONSOLE
            </button>
          </div>
        ...
        <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl overflow-hidden shadow-2xl">
          {activeTab === 'social' && (
            <motion.div
              ...
              className="p-8"
            >
              <h2 className="text-xl font-mono text-blue-400 mb-6 flex items-center">
              ...
              <div className="grid grid-cols-3 gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className={`p-4 rounded-lg border border-gray-800 hover:border-gray-700 transition-all ${index === isHovering ? 'bg-gray-800/50' : 'bg-gray-900/50'}`}
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-xs font-mono truncate">{social.url.replace('mailto:', '').replace('tel:', '')}</p>
                      </div>
                    </div>
                  </motion.a>
                ))}
          ...
          {activeTab === 'form' && (
            <motion.div
              ...
              className="p-8"
            >
              <h2 className="text-xl font-mono text-purple-400 mb-6 flex items-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent text-white placeholder-gray-500 font-mono text-sm"
                ...
                <div className="flex justify-center">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`px-6 py-3 bg-gradient-to-r from-purple-900/50 to-purple-900/50 rounded-lg text-purple-300 font-mono text-sm font-medium border border-purple-500/30 hover:shadow-lg hover:shadow-purple-500/20 transition-all ${
