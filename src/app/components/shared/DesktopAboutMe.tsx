      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-regular font-mono text-white">ABOUT_ME</h2>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div>
                ...
                <div className="font-mono font-light flex items-center gap-2 text-blue-500">
            ...
            <div className="bg-gray-700/30 rounded-lg p-4 border border-gray-600">
                <h3 className="text-white font-regular font-mono mb-3 flex items-center gap-2">
                    ...
                    <div key={index} className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        <div className="flex justify-between mb-1">
                          <span className="text-s text-gray-300">{lang.name}</span>
        ...
        <motion.div
          ...
          className="bg-gray-800/30 backdrop-blur-sm rounded-xl p-5 border border-gray-700 mb-8"
        >
          <div className="flex items-center gap-2 mb-4">
            <div className="p-1.5 bg-blue-900/30 rounded-lg">
              <TrendingUp className="text-blue-500" size={20} />
            </div>
            <h2 className="text-xl font-regular font-mono text-white">PROFICIENCY_SCALE</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {proficiencyScale.map((item, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
                className="bg-gray-700/20 rounded-lg p-4 border border-gray-600 hover:border-blue-500 transition-all"
              >
                <div className="flex items-center gap-3 mb-2">
                  {item.icon}
                  <span className="font-mono text-blue-500">{item.range}</span>
                </div>
                <h3 className="font-mono text-white font-medium mb-1">{item.level}</h3>
        ...
        >
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-xl font-regular font-mono text-white">CMS_EXPERIENCE</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {cmsSkills.map((cms, index) => (
              <motion.div
                key={index}
                whileHover={{ y: -3 }}
                className="bg-gray-700/40 rounded-lg p-4 border border-gray-600 hover:border-blue-500 transition-all group"
              >
                <div className="flex items-center gap-3 mb-3">
                  {cms.icon}
                  <h3 className="text-white font-medium">{cms.name}</h3>
                </div>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-gray-300 font-mono font-regular">{cms.name}</span>
              ...
              <div className="space-y-4">
                {category.skills.map((skill, skillIndex) => (
                  <div key={skillIndex} className="group">
                    <div className="flex justify-between items-center mb-1">
                      <span className="text-gray-300 font-mono font-regular">{skill.name}</span>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <h2 className="text-xl font-regular font-mono text-gray-200 mb-6 flex items-center gap-2">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
            <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 text-center">
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-blue-900/30 p-4 rounded-lg border border-blue-500/50 cursor-pointer"
              >
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-green-900/30 p-4 rounded-lg border border-green-500/30 cursor-pointer"
              >
              ...
              >
                ...
                <h3 className="text-white font-medium">Dev Tools</h3>
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-yellow-900/30 p-4 rounded-lg border border-yellow-500/30 cursor-pointer"
              >
              ...
              <motion.div
                whileHover={{ y: -5 }}
                className="bg-red-900/30 p-4 rounded-lg border border-red-500/30 cursor-pointer"
              >
