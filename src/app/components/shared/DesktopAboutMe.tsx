  ...
  <div className="h-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 rounded-2xl p-8 overflow-auto">
    <div className="max-w-6xl mx-auto">
      ...
      <motion.div
        ...
        className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl shadow-sm p-6 border border-gray-200 dark:border-gray-700 hover:border-blue-600 mb-6"
      >
        ...
        <div className="space-y-6">
          ...
          <div>
              ...
              <div className="font-mono font-light flex items-center gap-2 text-blue-600 dark:text-blue-600">
                <MapPin className="text-blue-600 dark:text-blue-600" size={18} />
                <span>{aboutMeText.location}</span>
              </div>
          </div>

          {/* Languages Section */}
          <div className="bg-gray-100 dark:bg-gray-700/30 rounded-2xl p-4 border border-gray-200 dark:border-gray-600">
      ...
      <motion.div
        ...
        className="bg-white/70 dark:bg-gray-800/30 backdrop-blur-sm rounded-3xl shadow-sm p-5 border border-gray-200 dark:border-gray-700 mb-8"
      >
        <div className="flex items-center gap-2 mb-4">
          <div className="p-1.5 bg-blue-100 dark:bg-blue-900/30 rounded-lg">
            <TrendingUp className="text-blue-600 dark:text-blue-600" size={20} />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {proficiencyScale.map((item, index) => (
            <motion.div
              key={index}
              whileHover={{ y: -3 }}
              className="bg-gray-100/70 dark:bg-gray-700/20 rounded-2xl p-4 border border-gray-200 dark:border-gray-600 hover:border-blue-600 transition-all"
            >
              <div className="flex items-center gap-3 mb-2">
                {item.icon}
                <span className="font-mono text-blue-600">{item.range}</span>
              </div>
      ...
      <motion.div
        ...
        className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl shadow-sm p-6 border border-gray-200 dark:border-gray-700 mb-8"
      >
        <div className="flex items-center gap-3 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {skillCategories.map((category, catIndex) => (
          <motion.div
            ...
            className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl shadow-sm p-6 border border-gray-200 dark:border-gray-700 hover:border-blue-600 transition-all duration-300"
          >
            <div className="flex items-center gap-3 mb-4">
      ...
      >
        ...
        <div className="bg-white/80 dark:bg-gray-800/50 backdrop-blur-sm rounded-3xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 text-center">
            {/* Frontend */}
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-blue-100 dark:bg-blue-900/30 p-4 rounded-2xl border border-blue-200 dark:border-blue-600/50 cursor-pointer"
            >
              <Code className="mx-auto text-blue-600 mb-2" size={28} />
              <h3 className="text-gray-900 dark:text-white font-medium">Frontend</h3>
              <p className="text-xs font-mono text-blue-600 mt-1">4 languages</p>
            </motion.div>
            
            {/* Backend */}
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-green-100 dark:bg-green-900/30 p-4 rounded-2xl border border-green-200 dark:border-green-500/30 cursor-pointer"
            >
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-purple-100 dark:bg-purple-900/30 p-4 rounded-2xl border border-purple-200 dark:border-purple-500/30 cursor-pointer"
            >
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-yellow-100 dark:bg-yellow-900/30 p-4 rounded-2xl border border-yellow-200 dark:border-yellow-500/30 cursor-pointer"
            >
            ...
            <motion.div
              whileHover={{ y: -5 }}
              className="bg-red-100 dark:bg-red-900/30 p-4 rounded-2xl border border-red-200 dark:border-red-500/30 cursor-pointer"
            >
      ...
      {/* Glowing tech orbs */}
      <div className="fixed top-1/4 left-1/4 w-40 h-40 rounded-full bg-blue-600/10 filter blur-3xl pointer-events-none -z-10"></div>
