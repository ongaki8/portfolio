          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex bg-gray-800 rounded-md p-1"> 
              <button
                ...
                className={`p-2 rounded cursor-pointer ${viewMode === 'list' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}
                title="List View"
              >
                <FiList size={18} />
              </button>
              <button
                ...
                className={`p-2 rounded cursor-pointer ${viewMode === 'grid' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}
                title="Grid View"
              >
                <FiGrid size={18} />
              </button>
        ...
        {items.length > 0 ? (
          <>
            {viewMode === 'grid' ? (
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-8">
                {items.map((item, index) => (
                  ...
                  >
                    ...
                    <p className="text-white text-sm text-center max-w-full truncate px-1">
                      {item.name}
                    </p>
                  </motion.div>
                ))}
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg overflow-hidden mb-8">
                {items.map((item, index) => (
                  <motion.div
                    key={index}
                  ...
                  >
                    <div className="p-4 flex items-center gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-gray-400 text-xs mt-1 flex items-center gap-4">
            ...
            {selectedItem !== null && (
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="bg-gray-800/70 backdrop-blur-sm border border-gray-700 rounded-lg p-4 mb-6"
              >
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex gap-2">
                    <motion.button
                      ...
                      className="cursor-pointer px-3 py-1 bg-red-600/20 text-red-400 rounded-md border border-red-700/50 flex items-center gap-2"
                    >
                      <FiTrash2 size={16} />
                    </motion.button>
                  </div>
            ...
            <div className="flex justify-center">
              <motion.button
                ...
                className="cursor-pointer px-4 py-2 bg-red-600/20 text-red-400 text-xs font-mono rounded-md border border-red-700/50 flex items-center gap-2"
              >
          ...
          <div className="flex flex-col items-center justify-center h-64 bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg">
            <div className="p-4 bg-gray-900/30 rounded-full mb-4">
              <FiTrash2 className="text-gray-600" size={48} />
            </div>
            <h2 className="text-xl font-medium font-mono text-white mb-2">EMPTY_TRASH</h2>
            ...
            <motion.button
              ...
              className="cursor-pointer px-4 py-2 bg-blue-600/50 text-white text-xs rounded-md flex items-center gap-2"
            >
